...
import { deleteChallengeCommonProduct, queryChallengeCommonProduct } from './service';
import type { TableListItem } from './service';

// 理财师公共产品池管理
const CommonProductPool = () => {
  ...
  const handleDelete = useCallback(async (record) => {
    const { success, errorMsg } = await deleteChallengeCommonProduct({ ...record });
    if (success) {
    ...
    <>
      <ProTable<TableListItem>
        ...
        request={async (params) => {
          const result = await queryChallengeCommonProduct({
            ...params,
...
export default CommonProductPool;
