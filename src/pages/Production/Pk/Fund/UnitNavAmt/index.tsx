...
const UnitNavAmt = ({ fundCodes }: any) => {
    ...
    () => ({
      ...
      tooltip: {
        formatter: ({ fundName, fundAssetAmt }: any) => {
          return { name: fundName, value: `${fundAssetAmt}%` };
        },
      },
      slider: {
        start: 0.8,
  ...
  return (
    <Spin tip="加载中..." spinning={loading}>
      <div className="pk-unit-nav-amt-container">
