...
interface IRelativeColumnChart extends Omit<ICAProps<string>, 'onChangeParams'> {}

/**
 * 相对估值偏离
 */
const RelativeColumnChart: React.FC<IRelativeColumnChart> = ({ params }) => {
...
export default RelativeColumnChart;
