...
import { linearHotProducts } from './service';
...
const DynTableAndLine = () => {
  ...
  return (
    <ProCard gutter={[8, 0]} ghost>
      ...
      <ProCardPlus title="规模变化" layout="center" style={{ height: '390px' }}>
...
DynTableAndLine.isProCard = true;

export default DynTableAndLine;
